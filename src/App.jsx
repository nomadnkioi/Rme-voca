// GitHub Pages clean deployment trigger
                ...
                <div className="card-top">
                  ...
                  <div className="card-actions">
                    <button 
                      ...
                      title="자주 찾는 단어"
                    >
                      <svg viewBox="0 0 24 24" width="20" height="20" fill={favorites[v.id]?.frequent ? "#F692C6" : "none"} stroke={favorites[v.id]?.frequent ? "#F692C6" : "currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
